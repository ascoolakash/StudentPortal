...
continue = e => {
  ...
  handleSubmit = async e => {
    ...
    if (formValid(this.state)) {
      console.log(`
        --SUBMITTING--
        functionalrequirement: ${this.state.functionalrequirement}
      `);
    } else {
  ...
  handleChange = e => {
    ...
    switch (name) {
      case "functionalrequirement":
        formErrors.functionalrequirement =
  ...
  render() {
    ...
    return (
      ...
      <div className="functionalrequirement">
              <label htmlFor="functionalrequirement">Fuctional Requirement</label>
              <input
                placeholder="Fuctional Requirement"
                type="text"
                id="functionalrequirement"
                value={values.functionalrequirement}
                name="functionalrequirement"
                noValidate
                onChange={handleChange('functionalrequirement')}
              />
            </div>
            <div className="file">
            <input 
             id='file' 
             type="file" 
             name="pdf_functionalrequirement" 
             accept="*"
             onChange={handleChange('pdf_functionalrequirement')}
            />
            </div>
