            ...
            actions={[
              {
                icon: 'save',
                tooltip: 'Save User',
                //onClick: (event, rowData) => alert("Project Selected : " + rowData.projectname)
                onClick: async (event, rowData) => {
                    ...
                    console.log("JWT verification"+ decode.user.email);
                    var response = await fetch('/api/addProject', {
                      method: 'POST',
                      headers: {
                      ...
                      body: JSON.stringify({
                        //id:data._id,
                        studentemail:decode.user.email, 
                        projectname:rowData.projectname,
                        semester:rowData.semester,
                        year:rowData.year,
                        projectdetails:rowData.projectdetails,
