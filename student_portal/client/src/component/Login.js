...
class componentform extends Component {
  ...
  handleSubmit = async e => {
    ...
    console.log("AKASH SAURABH    "+this.state.email);
   ...
   // console.log("Tokken value generated : "+response.text());
    ...
    if(body)
    {
      ...
      //   this.props.history.push('/studentProDetail')
      // }else if(decode.user.userType === "Faculty"){
      //   this.props.history.push('/facProDetail')
  ...
  render() {
    ...
    if(this.state.loggedIn === true){
      return <Redirect to="/navigatestudent" />
    }
    return (
