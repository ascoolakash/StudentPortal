...
continue = e => {
  ...
  //     console.log(`
  //       --SUBMITTING--
  //       ofd process : ${this.state.customerrequirement}
  ...
  //     },
  //     body: JSON.stringify({customerrequirement:this.state.customerrequirement,
  //       })
  //   });
  ...
  //       formErrors.customerrequirement =
      ...
      <form id="form" onSubmit={this.handleSubmit} noValidate>
            <div className="engineering">
              ...
              <input
                ...
                value={values.customerReq}
                name="customerrequirement"
                noValidate
                onChange={handleChange('customerReq')}
              />
            </div>
            <div className="file">
            <input 
             id='file' 
             type="file" 
             name="pdf_customerReq" 
             onChange={handleChange('pdf_customerReq')}
            />
            </div>
