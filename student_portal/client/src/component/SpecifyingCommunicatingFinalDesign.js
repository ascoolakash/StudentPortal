...
class SpecifyingCommunicatingFinalDesign extends Component {
  ...
  render() {
    ...
    return (
      ...
      <div className="stakeholders">
              <label htmlFor="stakeholders">Specifying and Communicating the Final Design</label>
              <input
    ...
    export default SpecifyingCommunicatingFinalDesign;
