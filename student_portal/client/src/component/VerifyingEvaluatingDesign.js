...
class VerifyingEvaluatingDesign extends Component {
  ...
  render() {
    ...
    return (
      ...
      <div className="stakeholders">
              <label htmlFor="marketResearch">Verifying and Evaluating the Design</label>
              <input
                placeholder="Research the market"
                type="text"
                id="marketResearch"
                value={values.marketResearch}
                name="marketResearch"
                noValidate
                onChange={handleChange('marketResearch')}
              />
      </div>
            <div className="file">
            <input 
             id='file' 
             type="file" 
             name="pdf_marketResearch" 
             accept="*"
             onChange={handleChange('pdf_marketResearch')}
            />
            </div>
    ...
    export default VerifyingEvaluatingDesign;
