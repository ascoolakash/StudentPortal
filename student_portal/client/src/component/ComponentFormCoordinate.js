  ...
  handleSubmit = async e => {
    ...
    if (formValid(this.state)) {
      console.log(`
        ...
        Join Group:${this.state.joinGroup}
          ...
          <form id="form" onSubmit={this.handleSubmit} noValidate>
            ...
            {/* <div className="joinGroup">
              <label htmlFor="joinGroup">Join Group</label>
               <input
                className={formErrors.joinGroup.length > 0 ? "error" : null}
                ...
                onChange={this.handleChange}
              />
              {formErrors.joinGroup.length > 0 && (
                <span className="errorMessage">{formErrors.joinGroup}</span>
              )}
            </div>
            ...
            <div className="createAccount">
              ...
              <small><a href="/LoginCoordinate">Already Have an Account?</a></small>
            </div>
