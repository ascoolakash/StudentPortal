...
class DesignStrategy extends Component {
...
back = e => {
  ...
  handleSubmit = async e => {
    ...
    formData.append('SpecifyingCommunicatingFinalDesign', values.designTeam);
    formData.append('ImplementingDesignDecision', values.developTasks);
    formData.append('VerifyingEvaluatingDesign', values.marketResearch);
    formData.append('DesignStrategy', values.estimatedCost);
    formData.append('pdf_SpecifyingCommunicatingFinalDesign', fileField1.files[0]);
    formData.append('pdf_ImplementingDesignDecision', fileField2.files[0]);
    formData.append('pdf_VerifyingEvaluatingDesign', fileField3.files[0]);
    formData.append('pdf_DesignStrategy', fileField4.files[0]);
    ...
    var response = await fetch('/api/design_evaluation_and_communication', {
      method: 'POST',
      body: formData
    });
  ...
  render() {
    ...
    return (
      ...
      <div className="stakeholders">
              <label htmlFor="stakeholders">Design Strategy</label>
              <input
